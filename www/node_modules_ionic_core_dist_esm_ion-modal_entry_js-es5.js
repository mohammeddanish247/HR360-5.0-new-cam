(function () {
  ...
  (self["webpackChunkhr360"] = self["webpackChunkhr360"] || []).push([["node_modules_ionic_core_dist_esm_ion-modal_entry_js"], {
    /***/
    15678:
    /*!**************************************************************!*\
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _framework_delegate_94e770cc_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./framework-delegate-94e770cc.js */
      78086);
      /* harmony import */


      var _overlays_a62f858b_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      ...
      var _animation_822d986b_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      ...
      var createSwipeToCloseGesture = function createSwipeToCloseGesture(el, animation, onDismiss) {
        ...
        var onMove = function onMove(detail) {
          var step = (0, _helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_10__.k)(0.0001, detail.deltaY / height, 0.9999);
      ...
      var iosEnterAnimation = function iosEnterAnimation(baseEl, presentingEl) {
        var backdropAnimation = (0, _animation_822d986b_js__WEBPACK_IMPORTED_MODULE_7__.c)().addElement(baseEl.querySelector('ion-backdrop')).fromTo('opacity', 0.01, 'var(--backdrop-opacity)').beforeStyles({
          'pointer-events': 'none'
        }).afterClearStyles(['pointer-events']);
        var wrapperAnimation = (0, _animation_822d986b_js__WEBPACK_IMPORTED_MODULE_7__.c)().addElement(baseEl.querySelectorAll('.modal-wrapper, .modal-shadow')).beforeStyles({
          'opacity': 1
        }).fromTo('transform', 'translateY(100vh)', 'translateY(0vh)');
        var baseAnimation = (0, _animation_822d986b_js__WEBPACK_IMPORTED_MODULE_7__.c)().addElement(baseEl).easing('cubic-bezier(0.32,0.72,0,1)').duration(500).addAnimation(wrapperAnimation);

        if (presentingEl) {
          var isMobile = window.innerWidth < 768;
          var hasCardModal = presentingEl.tagName === 'ION-MODAL' && presentingEl.presentingElement !== undefined;
          var presentingAnimation = (0, _animation_822d986b_js__WEBPACK_IMPORTED_MODULE_7__.c)().beforeStyles({
          ...
          if (isMobile) {
            ...
            if (!hasCardModal) {
              ...
              var shadowAnimation = (0, _animation_822d986b_js__WEBPACK_IMPORTED_MODULE_7__.c)().afterStyles({
                'transform': _finalTransform
      ...
      var iosLeaveAnimation = function iosLeaveAnimation(baseEl, presentingEl) {
        ...
        var backdropAnimation = (0, _animation_822d986b_js__WEBPACK_IMPORTED_MODULE_7__.c)().addElement(baseEl.querySelector('ion-backdrop')).fromTo('opacity', 'var(--backdrop-opacity)', 0.0);
        var wrapperAnimation = (0, _animation_822d986b_js__WEBPACK_IMPORTED_MODULE_7__.c)().addElement(baseEl.querySelectorAll('.modal-wrapper, .modal-shadow')).beforeStyles({
          'opacity': 1
        }).fromTo('transform', 'translateY(0vh)', 'translateY(100vh)');
        var baseAnimation = (0, _animation_822d986b_js__WEBPACK_IMPORTED_MODULE_7__.c)().addElement(baseEl).easing('cubic-bezier(0.32,0.72,0,1)').duration(duration).addAnimation(wrapperAnimation);

        if (presentingEl) {
          var isMobile = window.innerWidth < 768;
          var hasCardModal = presentingEl.tagName === 'ION-MODAL' && presentingEl.presentingElement !== undefined;
          var presentingAnimation = (0, _animation_822d986b_js__WEBPACK_IMPORTED_MODULE_7__.c)().beforeClearStyles(['transform']).afterClearStyles(['transform']).onFinish(function (currentStep) {
          ...
          if (isMobile) {
            ...
            if (!hasCardModal) {
              ...
              var shadowAnimation = (0, _animation_822d986b_js__WEBPACK_IMPORTED_MODULE_7__.c)().addElement(presentingEl.querySelector('.modal-shadow')).afterStyles({
                'transform': 'translateY(0) scale(1)'
              }).keyframes([{
                offset: 0,
                opacity: '0',
      ...
      var mdEnterAnimation = function mdEnterAnimation(baseEl) {
        var baseAnimation = (0, _animation_822d986b_js__WEBPACK_IMPORTED_MODULE_7__.c)();
        var backdropAnimation = (0, _animation_822d986b_js__WEBPACK_IMPORTED_MODULE_7__.c)();
        var wrapperAnimation = (0, _animation_822d986b_js__WEBPACK_IMPORTED_MODULE_7__.c)();
      ...
      var Modal = /*#__PURE__*/function () {
        function Modal(hostRef) {
          ...
          this.onBackdropTap = function () {
            _this4.dismiss(undefined, _overlays_a62f858b_js__WEBPACK_IMPORTED_MODULE_4__.B);
          };
        ...
        _createClass(Modal, [{
                ...
                while (1) {
                  switch (_context.prev = _context.next) {
                    ...
                    case 5:
                      ...
                      _context.next = 8;
                      return (0, _framework_delegate_94e770cc_js__WEBPACK_IMPORTED_MODULE_3__.a)(_this.delegate, container, _this.component, ['ion-page'], componentProps);

                    case 8:
                      _this.usersElement = _context.sent;
                      _context.next = 11;
                      return (0, _index_a7711c1e_js__WEBPACK_IMPORTED_MODULE_6__.e)(_this.usersElement);
                    ...
                    case 11:
                      ...
                      _context.next = 14;
                      return (0, _overlays_a62f858b_js__WEBPACK_IMPORTED_MODULE_4__.d)(_this, 'modalEnter', iosEnterAnimation, mdEnterAnimation, _this.presentingElement);
          ...
          value: function initSwipeToClose() {
            ...
            this.gesture = createSwipeToCloseGesture(this.el, ani, function () {
              ...
              _this5.animation.onFinish( /*#__PURE__*/(0, D_Stable_HR360_stable_ionic5_0_master_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
              ...
              return _regeneratorRuntime().wrap(function _callee3$(_context3) {
                while (1) {
                  switch (_context3.prev = _context3.next) {
                    ...
                    case 2:
                      enteringAnimation = _overlays_a62f858b_js__WEBPACK_IMPORTED_MODULE_4__.h.get(_this3) || [];
                      _context3.next = 5;
                      return (0, _overlays_a62f858b_js__WEBPACK_IMPORTED_MODULE_4__.f)(_this3, data, role, 'modalLeave', iosLeaveAnimation, mdLeaveAnimation, _this3.presentingElement);
                    ...
                    case 5:
                      ...
                      _context3.next = 9;
                      return (0, _framework_delegate_94e770cc_js__WEBPACK_IMPORTED_MODULE_3__.d)(_this3.delegate, _this3.usersElement);
